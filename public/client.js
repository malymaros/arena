...
const HEAD_CROP = {
  ...
  escanor:   { cx: 0.482, cy: 0.755, size: 0.11 }, // hlava zo slabej formy (WeakIdle) — figúra je DROBNÁ (~22×63 px pri spodku 226px framu), preto malý výrez nízko; cx mierne vľavo od stredu figúry = hlava v okienku sedí viac vpravo
};
